Citizen.CreateThread(function()
    ...
    while true do
        ...
        --DrawTxt(0.8, 0.50, 0.4,0.4,0.30, "Heading: " .. GetEntityHeading(GetPlayerPed(-1)), 255, 255, 255, 255, false, 1)
        --DrawTxt(0.8, 0.52, 0.4,0.4,0.30, "Coords: " .. pos, 255, 255, 255, 255, false, 1)
        --DrawTxt(0.8, 0.56, 0.4,0.4,0.30, "Health: " .. GetEntityHealth(GetPlayerPed(-1)), 255, 255, 255, 255, false, 1)
      -- DrawTxt(0.8, 0.62, 0.4,0.4,0.30, "Speed: " .. GetEntitySpeed(GetPlayerPed(-1)), 255, 255, 255, 255, false, 1)
